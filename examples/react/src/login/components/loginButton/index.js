...
import Roboto from '../../../global/assets/Roboto-Medium.ttf'
...
export class LoginButton extends Component {
  constructor(props) {
    ...
    let providerStyle=require(`../../../global/assets/${this.props.provider}-style.json`) || {}; //get the style for this provider
    this.state = {
    ...
    return (
      <div>
        <button style={buttonStyle} onClick={() => {onClickCallback(provider)}}> 
          <img style={logoStyle} src={require(`../../../global/assets/${provider}-logo.png`)} alt={text}/>{text}
        </button>
      </div>
    );
  }
